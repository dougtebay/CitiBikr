...
class StationTest extends PHPUnit_Framework_TestCase
{
  ...
  public function testIdentifiesNearbyStation()
  {
    $coordinates = $this->station->station_coordinates(40.76727216, -73.99392888);
    $station1 = $this->station->stations()[0];
    $station2 = $this->station->stations()[1];
    $result1 = $this->station->station_nearby($coordinates, $station1) ? 'true' : 'false';
    $result2 = $this->station->station_nearby($coordinates, $station2) ? 'true' : 'false';
